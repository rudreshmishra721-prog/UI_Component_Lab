...
function ChildrenProps() {
  return (
    <section className="p-8 bg-white rounded-xl shadow-lg">
      <h2 className="text-3xl font-bold mb-4 text-gray-800">Children prop</h2>
      <p className="text-gray-600 mb-6">The{" "}
        <code className="bg-gray-100 px-2 py-1 rounded text-sm">children</code>{" "} Lorem ipsum dolor sit amet consectetur adipisicing elit.
         Quibusdam in assumenda ut! Quae, voluptas. Expedita.</p>
      <div className="space-y-6">
        <div>
          <h3 className="text-xl font-semibold mb-4 text-gray-700">
            Card component with children</h3>
          <Container layout ="grid">
            <Card title="User Profile" color="blue">
              <p className="mb-2">
                <strong>Name:</strong>Rudresh Mishra
              </p>
              <p className="mb-2">
                <strong>Email:</strong>RudreshMishra@gmail.com
              </p>
              <p className="mb-2">
                <strong>Role:</strong>Developer
              </p>
            </Card>
            <Card title="Staticstics" color="green">
             <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="Zfont-bold">567</span>
              </div>
              <div className="flex justify-between">
                <span>Revenue:</span>
            ...
            <Card title="Warning" color="red">
              <p>Your trial period ends in 5 days. Please upgrade your account to
